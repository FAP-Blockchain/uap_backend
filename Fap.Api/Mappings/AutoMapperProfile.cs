...
namespace Fap.Api.Mappings
{
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            // Student -> StudentDto (for list view)
            ...
            // Student -> StudentDetailDto (for detail view)
            ...
            // ClassMember -> ClassInfo
            CreateMap<ClassMember, ClassInfo>()
            ...
            // Teacher -> TeacherDto (for list view)
            ...
            // Teacher -> TeacherDetailDto (for detail view)
            CreateMap<Teacher, TeacherDetailDto>()
                ...
                .ForMember(dest => dest.TotalStudents, opt => opt.MapFrom(src => 
                    src.Classes != null ? src.Classes.Sum(c => c.Members != null ? c.Members.Count : 0) : 0))
                .ForMember(dest => dest.Classes, opt => opt.MapFrom(src => src.Classes));

            // Class -> TeachingClassInfo
            ...
            // Class -> ClassDetailDto (for detail view)
            ...
            // Enroll -> ClassEnrollmentInfo
            CreateMap<Enroll, ClassEnrollmentInfo>()
            ...
            // Slot -> ClassSlotInfo
            CreateMap<Slot, ClassSlotInfo>()
                .ForMember(dest => dest.SlotId, opt => opt.MapFrom(src => src.Id))
                .ForMember(dest => dest.Date, opt => opt.MapFrom(src => src.Date))
                .ForMember(dest => dest.TimeSlotName, opt => opt.MapFrom(src => src.TimeSlot != null ? src.TimeSlot.Name : "N/A"))
                ...
                .ForMember(dest => dest.SubstituteTeacherName, opt => opt.MapFrom(src => 
                    src.SubstituteTeacher != null ? src.SubstituteTeacher.User.FullName : null))
                .ForMember(dest => dest.TotalAttendances, opt => opt.MapFrom(src => src.Attendances != null ? src.Attendances.Count : 0));
