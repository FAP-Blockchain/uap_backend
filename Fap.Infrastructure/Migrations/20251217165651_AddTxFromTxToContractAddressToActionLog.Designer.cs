...
namespace Fap.Infrastructure.Migrations
{
    ...
    [Migration("20251217165651_AddTxFromTxToContractAddressToActionLog")]
    partial class AddTxFromTxToContractAddressToActionLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fap.Domain.Entities.AppSetting", b =>
                {
            ...
            modelBuilder.Entity("Fap.Domain.Entities.Attendance", b =>
                {
                    ...
                    b.Property<long?>("OnChainRecordId")
                        .HasColumnType("bigint");

                    b.Property<string>("OnChainTransactionHash")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Fap.Domain.Entities.Specialization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Fap.Domain.Entities.SubjectSpecialization", b =>
                {
                    b.Property<Guid>("SubjectId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("SubjectId", "SpecializationId");
            ...
            modelBuilder.Entity("Fap.Domain.Entities.TeacherSpecialization", b =>
                {
                    ...
                    b.HasKey("TeacherId", "SpecializationId");
            ...
            modelBuilder.Entity("Fap.Domain.Entities.GradeComponent", b =>
                {
                    b.HasOne("Fap.Domain.Entities.GradeComponent", "Parent")
            ...
            modelBuilder.Entity("Fap.Domain.Entities.SubjectSpecialization", b =>
                {
                    b.HasOne("Fap.Domain.Entities.Specialization", "Specialization")
